...
export declare type Properties<T> = Pick<
  T,
  {
...
export declare type Node<T, P> = ExtendedColors<
  Overwrite<Partial<T>, NodeProps<T, P>>
>;
...
> &
  EventHandlers;
export declare type BufferGeometryNode<
...
export declare type Object3DProps = Object3DNode<
  THREE.Object3D,
  typeof THREE.Object3D
>;
export declare type AudioListenerProps = Object3DNode<
  THREE.AudioListener,
  typeof THREE.AudioListener
>;
export declare type PositionalAudioProps = Object3DNode<
  THREE.PositionalAudio,
  typeof THREE.PositionalAudio
>;
export declare type MeshProps = Object3DNode<THREE.Mesh, typeof THREE.Mesh>;
export declare type InstancedMeshProps = Object3DNode<
  THREE.InstancedMesh,
  typeof THREE.InstancedMesh
>;
export declare type SceneProps = Object3DNode<THREE.Scene, typeof THREE.Scene>;
export declare type SpriteProps = Object3DNode<
  THREE.Sprite,
  typeof THREE.Sprite
>;
export declare type LODProps = Object3DNode<THREE.LOD, typeof THREE.LOD>;
export declare type SkinnedMeshProps = Object3DNode<
  THREE.SkinnedMesh,
  typeof THREE.SkinnedMesh
>;
export declare type SkeletonProps = Object3DNode<
  THREE.Skeleton,
  typeof THREE.Skeleton
>;
export declare type BoneProps = Object3DNode<THREE.Bone, typeof THREE.Bone>;
export declare type LineSegmentsProps = Object3DNode<
  THREE.LineSegments,
  typeof THREE.LineSegments
>;
export declare type LineLoopProps = Object3DNode<
  THREE.LineLoop,
  typeof THREE.LineLoop
>;
export declare type PointsProps = Object3DNode<
  THREE.Points,
  typeof THREE.Points
>;
export declare type GroupProps = Object3DNode<THREE.Group, typeof THREE.Group>;
export declare type CameraProps = Object3DNode<
  THREE.Camera,
  typeof THREE.Camera
>;
export declare type PerspectiveCameraProps = Object3DNode<
  THREE.PerspectiveCamera,
  typeof THREE.PerspectiveCamera
>;
export declare type OrthographicCameraProps = Object3DNode<
  THREE.OrthographicCamera,
  typeof THREE.OrthographicCamera
>;
export declare type CubeCameraProps = Object3DNode<
  THREE.CubeCamera,
  typeof THREE.CubeCamera
>;
export declare type ArrayCameraProps = Object3DNode<
  THREE.ArrayCamera,
...
>;
export declare type BufferGeometryProps = BufferGeometryNode<
  THREE.BufferGeometry,
  typeof THREE.BufferGeometry
>;
/** @ts-ignore */
export declare type BoxBufferGeometryProps = BufferGeometryNode<
...
>;
export declare type WireframeGeometryProps = BufferGeometryNode<
...
>;
export declare type TubeGeometryProps = BufferGeometryNode<
  THREE.TubeGeometry,
  typeof THREE.TubeGeometry
>;
export declare type TorusKnotGeometryProps = BufferGeometryNode<
  THREE.TorusKnotGeometry,
  typeof THREE.TorusKnotGeometry
>;
export declare type TorusGeometryProps = BufferGeometryNode<
  THREE.TorusGeometry,
  typeof THREE.TorusGeometry
>;
export declare type SphereGeometryProps = BufferGeometryNode<
  THREE.SphereGeometry,
  typeof THREE.SphereGeometry
>;
export declare type RingGeometryProps = BufferGeometryNode<
  THREE.RingGeometry,
  typeof THREE.RingGeometry
>;
export declare type PlaneGeometryProps = BufferGeometryNode<
  THREE.PlaneGeometry,
  typeof THREE.PlaneGeometry
>;
export declare type LatheGeometryProps = BufferGeometryNode<
  THREE.LatheGeometry,
  typeof THREE.LatheGeometry
>;
export declare type ShapeGeometryProps = BufferGeometryNode<
  THREE.ShapeGeometry,
  typeof THREE.ShapeGeometry
>;
export declare type ExtrudeGeometryProps = BufferGeometryNode<
  THREE.ExtrudeGeometry,
  typeof THREE.ExtrudeGeometry
>;
export declare type EdgesGeometryProps = BufferGeometryNode<
  THREE.EdgesGeometry,
  typeof THREE.EdgesGeometry
>;
export declare type ConeGeometryProps = BufferGeometryNode<
  THREE.ConeGeometry,
  typeof THREE.ConeGeometry
>;
export declare type CylinderGeometryProps = BufferGeometryNode<
  THREE.CylinderGeometry,
  typeof THREE.CylinderGeometry
>;
export declare type CircleGeometryProps = BufferGeometryNode<
  THREE.CircleGeometry,
  typeof THREE.CircleGeometry
>;
export declare type BoxGeometryProps = BufferGeometryNode<
  THREE.BoxGeometry,
  typeof THREE.BoxGeometry
>;
export declare type CapsuleGeometryProps = BufferGeometryNode<
  THREE.CapsuleGeometry,
  typeof THREE.CapsuleGeometry
>;
export declare type MaterialProps = MaterialNode<
  THREE.Material,
  [THREE.MaterialParameters]
>;
export declare type ShadowMaterialProps = MaterialNode<
  THREE.ShadowMaterial,
  [THREE.ShaderMaterialParameters]
>;
export declare type SpriteMaterialProps = MaterialNode<
  THREE.SpriteMaterial,
  [THREE.SpriteMaterialParameters]
>;
export declare type RawShaderMaterialProps = MaterialNode<
  THREE.RawShaderMaterial,
  [THREE.ShaderMaterialParameters]
>;
export declare type ShaderMaterialProps = MaterialNode<
  THREE.ShaderMaterial,
  [THREE.ShaderMaterialParameters]
>;
export declare type PointsMaterialProps = MaterialNode<
...
>;
export declare type MeshPhongMaterialProps = MaterialNode<
  THREE.MeshPhongMaterial,
  [THREE.MeshPhongMaterialParameters]
>;
export declare type MeshToonMaterialProps = MaterialNode<
...
>;
export declare type MeshDepthMaterialProps = MaterialNode<
...
>;
export declare type MeshBasicMaterialProps = MaterialNode<
...
>;
export declare type LineBasicMaterialProps = MaterialNode<
...
export declare type SpotLightShadowProps = Node<
  THREE.SpotLightShadow,
  typeof THREE.SpotLightShadow
>;
export declare type SpotLightProps = LightNode<
  THREE.SpotLight,
  typeof THREE.SpotLight
>;
export declare type PointLightProps = LightNode<
  THREE.PointLight,
  typeof THREE.PointLight
>;
export declare type RectAreaLightProps = LightNode<
  THREE.RectAreaLight,
  typeof THREE.RectAreaLight
>;
export declare type HemisphereLightProps = LightNode<
...
>;
export declare type DirectionalLightProps = LightNode<
  THREE.DirectionalLight,
  typeof THREE.DirectionalLight
>;
export declare type AmbientLightProps = LightNode<
  THREE.AmbientLight,
  typeof THREE.AmbientLight
>;
export declare type LightShadowProps = Node<
  THREE.LightShadow,
  typeof THREE.LightShadow
>;
/** @ts-ignore */
export declare type AmbientLightProbeProps = LightNode<
  THREE.AmbientLightProbe,
  typeof THREE.AmbientLightProbe
>;
/** @ts-ignore */
export declare type HemisphereLightProbeProps = LightNode<
  THREE.HemisphereLightProbe,
  typeof THREE.HemisphereLightProbe
>;
export declare type LightProbeProps = LightNode<
  THREE.LightProbe,
  typeof THREE.LightProbe
>;
export declare type SpotLightHelperProps = Object3DNode<
  THREE.SpotLightHelper,
  typeof THREE.SpotLightHelper
>;
export declare type SkeletonHelperProps = Object3DNode<
  THREE.SkeletonHelper,
  typeof THREE.SkeletonHelper
>;
export declare type PointLightHelperProps = Object3DNode<
...
>;
export declare type GridHelperProps = Object3DNode<
  THREE.GridHelper,
  typeof THREE.GridHelper
>;
export declare type PolarGridHelperProps = Object3DNode<
...
>;
export declare type CameraHelperProps = Object3DNode<
  THREE.CameraHelper,
  typeof THREE.CameraHelper
>;
export declare type BoxHelperProps = Object3DNode<
  THREE.BoxHelper,
  typeof THREE.BoxHelper
>;
export declare type Box3HelperProps = Object3DNode<
  THREE.Box3Helper,
  typeof THREE.Box3Helper
>;
export declare type PlaneHelperProps = Object3DNode<
  THREE.PlaneHelper,
  typeof THREE.PlaneHelper
>;
export declare type ArrowHelperProps = Object3DNode<
  THREE.ArrowHelper,
  typeof THREE.ArrowHelper
>;
export declare type AxesHelperProps = Object3DNode<
  THREE.AxesHelper,
  typeof THREE.AxesHelper
>;
export declare type TextureProps = Node<THREE.Texture, typeof THREE.Texture>;
export declare type VideoTextureProps = Node<
  THREE.VideoTexture,
  typeof THREE.VideoTexture
>;
export declare type DataTextureProps = Node<
  THREE.DataTexture,
  typeof THREE.DataTexture
>;
/** @ts-ignore */
export declare type DataTexture3DProps = Node<
  THREE.DataTexture3D,
  typeof THREE.DataTexture3D
>;

export declare type CompressedTextureProps = Node<
  THREE.CompressedTexture,
  typeof THREE.CompressedTexture
>;
export declare type CubeTextureProps = Node<
  THREE.CubeTexture,
  typeof THREE.CubeTexture
>;
export declare type CanvasTextureProps = Node<
  THREE.CanvasTexture,
  typeof THREE.CanvasTexture
>;
export declare type DepthTextureProps = Node<
  THREE.DepthTexture,
  typeof THREE.DepthTexture
>;
export declare type RaycasterProps = Node<
  THREE.Raycaster,
...
export declare type QuaternionProps = Node<
  THREE.Quaternion,
  typeof THREE.Quaternion
>;
export declare type BufferAttributeProps = Node<
  THREE.BufferAttribute,
  typeof THREE.BufferAttribute
>;
export declare type Float16BufferAttributeProps = Node<
  THREE.Float16BufferAttribute,
  typeof THREE.Float16BufferAttribute
>;
export declare type Float32BufferAttributeProps = Node<
  THREE.Float32BufferAttribute,
  typeof THREE.Float32BufferAttribute
>;
export declare type Float64BufferAttributeProps = Node<
  THREE.Float64BufferAttribute,
  typeof THREE.Float64BufferAttribute
>;
export declare type Int8BufferAttributeProps = Node<
  THREE.Int8BufferAttribute,
  typeof THREE.Int8BufferAttribute
>;
export declare type Int16BufferAttributeProps = Node<
  THREE.Int16BufferAttribute,
  typeof THREE.Int16BufferAttribute
>;
export declare type Int32BufferAttributeProps = Node<
  THREE.Int32BufferAttribute,
  typeof THREE.Int32BufferAttribute
>;
export declare type Uint8BufferAttributeProps = Node<
  THREE.Uint8BufferAttribute,
  typeof THREE.Uint8BufferAttribute
>;
export declare type Uint16BufferAttributeProps = Node<
  THREE.Uint16BufferAttribute,
  typeof THREE.Uint16BufferAttribute
>;
export declare type Uint32BufferAttributeProps = Node<
  THREE.Uint32BufferAttribute,
  typeof THREE.Uint32BufferAttribute
>;
